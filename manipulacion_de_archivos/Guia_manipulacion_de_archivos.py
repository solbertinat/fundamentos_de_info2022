...
import os
import glob
path = (r"C:\Users\ulichtenbaum\Documents\Fundamentos_de_informatica\fundamentos_de_info2022\manipulacion_de_archivos\todos_txt.txt")

os.chdir(r'fundamentos_de_info2022\manipulacion_de_archivos')
lista_archivos = glob.glob("*.txt")
with open(path, "a") as archivo_final:
